...
export const sampleTemplates: SampleTemplate[] = [
      ...
      workExperiences: [
        {
          ...
          description:
            "Built and maintained responsive web applications serving 10M+ monthly users. Led the migration from legacy jQuery to React, improving page load performance by 35%. Implemented A/B testing frameworks that increased conversion rates by 18%.",
          visible: true,
        },
        {
          ...
          description:
            "Developed component library used across 5 product teams, reducing UI development time by 25%. Collaborated with UX designers to implement accessible interfaces meeting WCAG 2.1 AA standards.",
          visible: true,
        },
        {
  ...
  // =========================================================================
  {
    ...
    data: {
      ...
      summary:
        "Certified Project Management Professional with 8+ years of experience leading cross-functional teams in the automotive and manufacturing sectors. Skilled in Agile methodologies, risk management, and stakeholder communication. Delivered 30+ projects on time and under budget while maintaining high quality standards.",
      firstName: "Daryl",
      lastName: "Banks",
      ...
      workExperiences: [
        {
          ...
          location: "Munich, Germany",
          description:
            "• Led a team of 15 engineers in the development of a new electric vehicle charging infrastructure project (EUR 8M budget).\n• Implemented Agile/Scrum workflows that reduced delivery timelines by 20% across three concurrent project streams.\n• Coordinated with suppliers in China, Japan, and Germany to ensure on-time delivery of critical components.",
          visible: true,
        },
        {
          ...
          description:
            "• Managed software integration projects for automotive IoT sensors, serving 12 OEM clients.\n• Reduced project overhead costs by 18% through process optimization and resource reallocation.\n• Presented quarterly progress reports to C-level executives and board members.",
          visible: true,
        },
      ],
      educations: [
      ...
      languages: [
        { language: "German", proficiency: "Native", visible: true },
        { language: "English", proficiency: "Fluent", visible: true },
        { language: "French", proficiency: "Intermediate", visible: true },
      ],
      sectionOrder: [
        "personal-info",
        "summary",
  ...
  // =========================================================================
  {
    ...
    data: {
      ...
      fontFamily: "sans-serif",
      summary:
        "Creative Content Marketing Specialist with 7+ years of experience building brand presence through strategic content creation, SEO optimization, and social media campaigns. Proven track record of increasing organic traffic by 200% and growing engaged communities across multiple platforms.",
      firstName: "Mark",
      lastName: "Anderson",
  ...
  // =========================================================================
  {
    ...
    data: {
      ...
      summary:
        "User-centered UX Designer with 6+ years of experience creating intuitive digital products for SaaS and e-commerce platforms. Proficient in user research, wireframing, prototyping, and design systems. Passionate about turning complex user flows into simple, delightful experiences.",
      firstName: "Lukas",
      lastName: "Morgan",
      ...
      email: "lukas.morgan@example.com",
      ...
      workExperiences: [
        {
          ...
          description:
            "• Redesigned the hotel search experience, resulting in a 12% increase in conversion rate.\n• Led a design system initiative across 4 product teams, ensuring visual consistency.\n• Conducted A/B tests and usability studies with 200+ participants to validate design decisions.",
          visible: true,
        },
        {
          ...
          endDate: "2020-12-01",
          description:
            "• Designed the merchant onboarding flow, reducing drop-off by 25%.\n• Created interactive prototypes for the dashboard used by 5,000+ merchants globally.\n• Collaborated closely with engineering to ensure pixel-perfect implementation.",
          visible: true,
        },
      ],
      educations: [
        ...
        },
        {
          ...
          degree: "Bachelor of Science",
          fieldOfStudy: "Industrial Design Engineering",
      ...
      languages: [
        { language: "Dutch", proficiency: "Native", visible: true },
        { language: "English", proficiency: "Fluent", visible: true },
        { language: "German", proficiency: "Intermediate", visible: true },
      ],
      sectionOrder: [
        "personal-info",
        "profile",
  ...
  // =========================================================================
  {
    ...
    data: {
      ...
      summary:
        "Detail-oriented Financial Analyst with 5+ years of experience in financial modeling, forecasting, and investment analysis. Skilled in building complex Excel models, creating investor presentations, and supporting M&A due diligence. CFA Level II candidate with strong quantitative aptitude.",
      firstName: "Diamond",
      lastName: "Pedro",
      ...
      email: "diamond.pedro@example.com",
      linkedin: "linkedin.com/in/diamond-pedro",
      skills: [
        "Financial Modeling",
        "Excel & VBA",
        "Bloomberg Terminal",
      ...
      workExperiences: [
        {
          ...
          description:
            "• Built financial models for M&A transactions totaling over GBP 500M in deal value.\n• Prepared investment memoranda and pitch books for senior bankers and clients.\n• Conducted due diligence on 8+ acquisition targets across TMT and healthcare sectors.",
          visible: true,
        },
        {
          ...
          endDate: "2020-07-01",
          description:
            "• Assisted in preparing financial statements and valuation reports for audit engagements.\n• Performed variance analysis and trend identification for quarterly client reviews.\n• Supported the team in delivering 15+ client engagements on time and within budget.",
          visible: true,
        },
      ],
      educations: [
      ...
      languages: [
        { language: "English", proficiency: "Native", visible: true },
        { language: "Portuguese", proficiency: "Fluent", visible: true },
        { language: "Spanish", proficiency: "Conversational", visible: true },
      ],
      sectionOrder: [
        "personal-info",
  ...
  // =========================================================================
  {
    ...
    data: {
      ...
      fontFamily: "sans-serif",
      summary:
        "Detail-oriented Administrative Professional with 9+ years of experience in office management, executive support, and event coordination. Adept at maintaining confidentiality, managing calendars, and streamlining office operations. B.A. in Business Administration with advanced Microsoft Office proficiency.",
      firstName: "Ernie",
      lastName: "Dockwell",
      ...
      phone: "(210) 286-1624",
      email: "ernie.dockwell@example.com",
      skills: [
        "Calendar Management",
        "Event Coordination",
      ...
      workExperiences: [
        {
          ...
          description:
            "• Supported 3 C-suite executives with calendar management, travel arrangements, and meeting preparation.\n• Coordinated annual company retreat for 150+ employees, managing a USD 50K budget.\n• Implemented a new digital filing system that reduced document retrieval time by 40%.",
          visible: true,
        },
        {
          ...
          endDate: "2019-02-01",
          description:
            "• Managed front desk operations and supervised a team of 4 receptionists.\n• Processed invoices, purchase orders, and expense reports for a department of 30 staff.\n• Maintained strict HIPAA compliance for all patient-related administrative tasks.",
          visible: true,
        },
      ],
      educations: [
  ...
  // =========================================================================
  {
    ...
    data: {
      ...
      fontFamily: "sans-serif",
      summary:
        "Experienced logistics coordinator with 7+ years in supply chain management, route optimization, and fleet operations. Skilled in reducing delivery times, managing vendor relationships, and ensuring regulatory compliance across multi-state operations.",
      firstName: "Badhir",
      lastName: "Omar",
